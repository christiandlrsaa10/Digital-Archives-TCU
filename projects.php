                    ...
                    <a href="./?page=view_archive&id=<?= $row['id'] ?>" class="text-decoration-none text-dark list-group-item list-group-item-action">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-12">
                                ...
                                <small class="text-muted"><i class="fa fa-user-circle-o"></i> Uploaded By : <b class="text-info"><?= isset($student_arr[$row['student_id']]) ? $student_arr[$row['student_id']] : "N/A" ?></b></small>
